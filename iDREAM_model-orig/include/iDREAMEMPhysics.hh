...
//
//
#ifndef iDREAMEMPhysics_h
#define iDREAMEMPhysics_h 1
...
class iDREAMEMPhysics : public G4VPhysicsConstructor
{
  public:

    iDREAMEMPhysics(const G4String& name ="EM");
    virtual ~iDREAMEMPhysics();
