...
//
//
#ifndef iDREAMMuonPhysics_h
#define iDREAMMuonPhysics_h 1
...
class iDREAMMuonPhysics : public G4VPhysicsConstructor
{
  public:

    iDREAMMuonPhysics(const G4String& name="muon");
    virtual ~iDREAMMuonPhysics();
