...
iDREAMMuonPhysics::iDREAMMuonPhysics(const G4String& name)
...
iDREAMMuonPhysics::~iDREAMMuonPhysics() {}
...
void iDREAMMuonPhysics::ConstructParticle()
{
  // Mu
...
void iDREAMMuonPhysics::ConstructProcess()
{
