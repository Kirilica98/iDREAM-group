...
iDREAMEMPhysics::iDREAMEMPhysics(const G4String& name)
...
iDREAMEMPhysics::~iDREAMEMPhysics() {}
...
void iDREAMEMPhysics::ConstructParticle()
{
  // gamma
...
void iDREAMEMPhysics::ConstructProcess()
{
